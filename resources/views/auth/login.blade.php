...
.lp-sub{font-size:.82rem;color:rgba(255,255,255,.3);margin:0 0 1.75rem;line-height:1.55}
...
.lp-alert{background:rgba(124,58,237,.06);border:1px solid rgba(124,58,237,.15);color:#c4b5fd;border-radius:10px;padding:.6rem .85rem;font-size:.8rem;margin-bottom:1.25rem}
...
.lp-ckb{width:17px;height:17px;border-radius:5px;border:1.5px solid rgba(255,255,255,.1);background:rgba(255,255,255,.035);display:flex;align-items:center;justify-content:center;transition:all .2s cubic-bezier(.16,1,.3,1);flex-shrink:0}
.lp-ckb svg{width:11px;height:11px;color:#fff;opacity:0;transform:scale(.4);transition:all .2s cubic-bezier(.16,1,.3,1);display:block}
...
.lp-ck input:focus-visible+.lp-ckb{outline:2px solid #a78bfa;outline-offset:2px}
        ...
        <div class="lp-panels">
            ...
            <div class="lp-pnl">
                <div class="lp-pnl-in">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="lpForm">
                        @csrf
                        ...
                        <div class="lp-fg">
                            ...
                            <div class="lp-iw">
                                ...
                                <input type="email" name="email" id="email" class="lp-in {{ $errors->has('email') ? 'lp-err-input' : '' }}" value="{{ old('email') }}" placeholder="nama@email.com" required autofocus>
                            </div>
                        ...
                        <div class="lp-fg">
                            ...
                            <div class="lp-iw">
                                ...
                                <input type="password" name="password" id="lpPass" class="lp-in {{ $errors->has('password') ? 'lp-err-input' : '' }}" placeholder="Masukkan password" required>
                        ...
                        <button type="submit" class="lp-btn" id="lpBtn">
                        ...
                        <div class="lp-btm">
                            Belum punya akun? <a href="{{ route('register') }}" id="lpLinkReg">Daftar</a>
                        </div>
                    </form>
                </div>
            </div>

            <!-- RIGHT: Register (tertutup overlay) -->
            <div class="lp-pnl lp-hide-mobile">
                <div class="lp-pnl-in">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="lp-fg"><label>Nama</label><div class="lp-iw"><svg class="lp-ic" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"/></svg><input name="name" class="lp-in" placeholder="Nama lengkap" required></div></div>
                        <div class="lp-fg"><label>Email</label><div class="lp-iw"><svg class="lp-ic" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"/></svg><input type="email" name="email" class="lp-in" placeholder="nama@email.com" required></div></div>
                        <div class="lp-fg"><label>Password</label><div class="lp-iw"><svg class="lp-ic" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25Z"/></svg><input type="password" name="password" class="lp-in" placeholder="Buat password" required></div></div>
                        <div class="lp-fg"><label>Konfirmasi Password</label><div class="lp-iw"><svg class="lp-ic" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z"/></svg><input type="password" name="password_confirmation" class="lp-in" placeholder="Ulangi password" required></div></div>
                        <button type="submit" class="lp-btn" style="margin-top:.25rem"><span class="lp-btn-inner"><span>Buat Akun</span></span></button>
                        <div class="lp-btm">Sudah punya akun? <a href="{{ route('login') }}">Masuk</a></div>
                    </form>
                </div>
            </div>
        </div>

        <!-- Overlay (starts right = login mode) -->
        <div class="lp-ov" id="lpOv">
...
(function(){
    ...
    var ov=document.getElementById('lpOv'),regUrl='{{ route("register") }}';
    function slideToRegister(){sessionStorage.setItem('lp-smooth','1');ov.classList.add('lp-at-l');setTimeout(function(){window.location.href=regUrl},800)}
    document.getElementById('lpGoReg').addEventListener('click',slideToRegister);
    document.getElementById('lpLinkReg').addEventListener('click',function(e){e.preventDefault();slideToRegister()});
})();
</script>
@endsection