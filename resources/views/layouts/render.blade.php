...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .cv-paper{width:794px;margin:0 auto;background:#fff;padding:48px 52px;box-shadow:0 1px 3px rgba(0,0,0,.06),0 6px 24px rgba(0,0,0,.04);font-family:'Inter',sans-serif;color:#1f2937;font-size:14.5px;line-height:1.65}
        @media print{body{background:#fff;padding:0;margin:0}.cv-paper{width:100%;padding:0;margin:0;box-shadow:none}.toolbar{display:none!important}@page{size:A4;margin:12mm}}
    </style>
</head>
<body>
    <div class="toolbar">
